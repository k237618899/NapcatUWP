...
namespace WebSocket.UAP.Internal
{
     ...
     *                 <li>
     *                     If the flag is <code>true</code>, delimiter characters are themselves
    ...
    internal class StringTokenizer : Enumeration<object>
    {
        ...
        private void SetMaxDelimCodePoint()
        {
            ...
            int c;
            var count = 0;
            for (var i = 0; i < delimiters.Length; i += Character.CharCount(c))
            {
                c = delimiters[i];
        ...
        private int SkipDelimiters(int startPos)
        {
            ...
            while (!retDelims && position < maxPosition)
                ...
                {
                    var c = str.CodePointAt(position);
         ...
         * @exception  NoSuchElementException  if there are no more tokens in this
         * tokenizer's string.
         * @exception NullPointerException if delim is
         * <CODE>null</CODE>
         */
    ...
    internal static class StringTokenizerExtensions
    {
        ...
        {
            if (index < 0 || index >= value.Length) throw new IndexOutOfRangeException(index + "");
