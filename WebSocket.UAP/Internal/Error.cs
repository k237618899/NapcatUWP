namespace WebSocket.UAP.Internal
{
    ...
    {
        internal const string HandshakeInvalidSecWebSocketAccept =
        ...
        internal const string ExtensionsAlreadyRegistered =
            "An web socket extension with the same name is already registered:";
        ...
        internal const string PayloadLengthControlFrame =
