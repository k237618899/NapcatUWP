...
namespace WebSocket.UAP.ToolBox
{
    public static class ByteExtensions
    {
        ...
        {
            var stream = randomStream.GetInputStreamAt(0).AsStreamForRead();
            ...
            return memoryStream.GetWindowsRuntimeBuffer(0, (int)memoryStream.Length);
        }
